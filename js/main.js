...
function update(dt) {
    ...
    // ===== TOURNAMENT MATCH END - SIMPLIFIED =====
if (currentState === 'MATCH_END' && tournamentMode) {
    if (tournamentPendingMatch) {
        ...
        const groupId = tournamentPendingMatch.groupId;

        // Determine scores relative to the match's teamA/teamB
        ...
        console.log('[Tournament] Recording match result:', {
            matchId: matchId,
            teamA: tournamentPendingMatch.teamA.name,
            teamB: tournamentPendingMatch.teamB.name,
            teamAScore,
            teamBScore,
            isGroup,
            groupId: groupId
        ...
        // Record the result - the new TournamentManager will handle everything
